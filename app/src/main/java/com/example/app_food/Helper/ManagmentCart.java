package com.example.app_food.Helper;
...
public class ManagmentCart {
    ...
    public void insertFood(Foods item) {
        ...
        Toast.makeText(context, "Added to your Cart" + item.getTitle(), Toast.LENGTH_SHORT).show();
    }
    ...
    public void removeCartItem(ArrayList<Foods> listItem,int position,ChangeNumberItemsListener changeNumberItemsListener){
        String name = listItem.get(position).getTitle();
